...
| n° Iteration  | Objectif      | Temps escompté  | Rôles          | Effort escompté |
| ------------- | ------------- | --------------- | -------------- | --------------- |
| 1             | Colonne       | Colonne         |      Colonne   | Colonne         |
| 2             | Alignée à     |   Alignée au    |     Alignée à  | Alignée à       |
| Gauche        | Gauche        |      Centre     |      Droite    | Gauche          |
